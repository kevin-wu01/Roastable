      ...
      <div className="Dashboard-menu">
        <div className="Dashboard-menu-sidebar">
          <div className="Dashboard-menu-sidebar__profile">
            ...
            <div>
              <H3 className="Dashboard-menu-sidebar__name">
                {userData ? `${userData.firstName} ${userData.lastName}` : ''}
              </H3>
              <div className="Dashboard-menu-dropdown">
                <img
                  className="Dashboard-menu-dropdown__arrow"
                  src={DropdownArrow}
                  onClick={() => setDropdown(!dropdown)}
                />
                {dropdown ? (
                  <div className="Dashboard-menu-dropdown__content">
                    <button className="Dashboard-menu-dropdown__button" onClick={userLogOut}>
                      <H4>Log Out</H4>
                    </button>
                  </div>
                ) : (
          ...
          <div className="Dashboard-menu-sidebar__items">
            <button
              className="Dashboard-menu-sidebar__button"
              onClick={() => setSelectedMenu('home')}>
              <H2 className="Dashboard-menu-sidebar__title">Home</H2>
            </button>
            <button
              className="Dashboard-menu-sidebar__button"
              onClick={() => setSelectedMenu('messages')}>
              <H2 className="Dashboard-menu-sidebar__title">Messages</H2>
            </button>
            <button
              className="Dashboard-menu-sidebar__button"
              onClick={() => setSelectedMenu('people')}>
              <H2 className="Dashboard-menu-sidebar__title">People</H2>
            </button>
            <button
              className="Dashboard-menu-sidebar__button"
              onClick={() => setSelectedMenu('settings')}>
              <H2 className="Dashboard-menu-sidebar__title">Settings</H2>
            </button>
          </div>
          <div className="Dashboard-menu-sidebar__coffee">
            <button
              className="Dashboard-menu-sidebar__coffeeButton"
              onClick={() => redirectCoffee()}>
              <H2 className="Dashboard-menu-sidebar__coffeeTitle">Coffee Shop</H2>
            </button>
          </div>
        </div>
        <div className="Dashboard-menu-display">{menuContent}</div>
      </div>
    </div>
  );
}
